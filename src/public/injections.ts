...
module injections {
    ...
    export module components {
        ...
        export module forms {
            ...
            export module drink {
                export var template:string = "components/forms/drink/drink-form.html";
                export var controller:string = "drink-form-controller";
                export var directive:string = "drinkForm";
            }
        }
        export module page {
